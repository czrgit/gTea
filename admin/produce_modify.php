...
<body>
<form id="form1" name="form1" method="post" action="porduce_modify_pass.php?id=<?php echo $rs['id']?>">
...
<td><input name="thumbnail" type="text" id="url3" value="<?php echo $rs['thumbnail']?>" />
